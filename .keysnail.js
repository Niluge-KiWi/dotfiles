...
// from https://github.com/mooz/keysnail/wiki/tips#display-and-recover-recently-closed-tabs
...
// view page source
key.setViewKey(['C-c', 'C-u'], function () {
  BrowserViewSourceOfDocument(content.document);
}, 'View page source');

// Tree-Style Tab
key.setViewKey(['U'], function (ev, arg) {
  ext.exec("tst-select-parent-tab", arg);
}, "Select parent tab", true);

key.setViewKey(['C-U'], function (ev, arg) {
  ext.exec("tst-select-root-tab", arg);
}, "Select root tab", true);
